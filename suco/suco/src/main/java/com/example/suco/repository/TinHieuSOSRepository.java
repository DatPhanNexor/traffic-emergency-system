...
public interface TinHieuSOSRepository extends JpaRepository<TinHieuSOS, Long> {
    ...
    Optional<TinHieuSOS> findFirstByUserIdAndTrangThaiInOrderByCreatedAtDesc(
            String userId,
    ...
    List<TinHieuSOS> findByIdTruSoTiepNhanAndTrangThaiIn(
            Long idTruSo,
            List<String> trangThais
    );

    List<TinHieuSOS> findByIdTruSoTiepNhanAndTrangThai(
            Long idTruSo,
            String trangThai
    );
